            ...
            <div class="row">
                    ...
                    <div class="panel">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="true">Requisitos</a>
                            </h4>
                            <div id="collapse1" class="panel-collapse collapse in">
                            <li type="disc">Boleta oficial y de orientación (Original y copia  con acuse de recibido).</li>
                            <li type="disc">Ficha de depósito de $866.00 (Ochocientos Sesenta y Seis Pesos) </li>
                            <li type="disc">No adeudar más de 3 materias.</li>
                            <li type="disc">Los alumnos irregulares deberán presentarse con su papa, mama o el tutor responsable (de no ser así no podrá inscribirse).</li>
                            <li type="disc">CARNET DEL IMSS (2 copias)</li>
                            <li type="disc">En caso de adeudar algún documento, deberá entregarlo en la fecha determinada (certificado médico, fotografías, CURP e INE de padres)</li>
                            <li type="disc">Para todos los alumnos se les solicita 3 fotografías tamaño infantil blanco y negro, terminación mate y con uniforme.</li>
                            </div>
                        </div>
                        <div class="panel">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Alumnos provenientes de otras escuelas</a>
                            </h4>
                            <div id="collapse3" class="panel-collapse collapse">
                            <li type="disc">Historial académico original y copia., o equivalencia si su procedencia es de otros subsistemas.</li>
                            <li type="disc">Copia de ficha Kardex.</li>
                            <li type="disc">Boleta (Del o de los semestres anteriores).</li>
                            <li type="disc">Solicitud de inscripción debidamente requisitada (se proporcionara en la escuela).</li>
                            <li type="disc">Certificado de educación secundaria (original y copia).</li>
                            <li type="disc">Acta de nacimiento certificada (original y copia).</li>
                            <li type="disc">CURP (original y copia).</li>
