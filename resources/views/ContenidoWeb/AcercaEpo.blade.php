				...
				<div class="col-lg-7 pl-lg-0 offset-lg-5 cta-content">
					...
					<div class="testimonials-slider" id="test-slider">
						<div class="ts-item">
							...
							conocimientos  y actitudes acorde a los desempeños terminales expresados por el Sistema Nacional de Bachilleratos, en el marco de la universidad, con un enfoque humanista, basado en convivencia escolar armónica y cultura de paz para el desarrollo sano e integral de todos los agentes educativos que la conforman.</p>
						</div>
						<div class="ts-item">
							<h4>Visión</h4>
