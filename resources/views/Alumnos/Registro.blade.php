				...
				<div class="row">
						<div class="form-group" style="display: none">
			 				@if($errors->first('IdAlumno')) 
								<small> {{ $errors->first('IdAlumno') }} </small> <br>
							@endif
							<input type="number" class="form-control" id="IdAlumno" name="IdAlumno" value="{{$IdAlumno}}">
			 			</div>
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" id="Matricula" name="Matricula" placeholder="Introduce tu Matrícula" min="1">
			 		</div>
					...
					<div class="form-group col-xl-4">
						...
						<input type="text" class="form-control"id="APaterno" name="APaterno"	placeholder="Introduce tu Apellido Paterno">
					</div>
					...
					<div class="form-group col-xl-3">
						...
						<input type="text" class="form-control" id="AMaterno" name="AMaterno" placeholder="Introduce tu Apellido Materno">
					</div>
					...
					<div class="form-group col-xl-2">
						...
						<input type="Number" class="form-control" min="13" max="21" id="Edad" name="Edad">
					</div>
					...
					<div class="form-group col-xl-2">
						...
						<input type="text" class="form-control" id="Celular" name="Celular" placeholder="Introduce tu Celular">
					</div>
					...
					<div class="form-group col-xl-2">
						...
						<input type="text" class="form-control" id="TelFijo" name="TelFijo" placeholder="Introduce tu Tel. Fijo">
					</div>
					...
					<div class="form-group col-xl-4">
						...
						<input type="text" class="form-control" id="Calle" name="Calle" placeholder="Introduce tu Calle">
					</div>
					...
					<div class="form-group col-xl-2">
						...
						<input type="text" class="form-control" id="NumInt" name="NumInt"	placeholder="Introduce tu Núm. Int.">
					</div>
					...
					<div class="form-group col-xl-2">
						...
						<input type="text" class="form-control" id="NumExt" name="NumExt" placeholder="Introduce tu Núm. Ext.">
					</div>
					...
					<div class="form-group col-xl-2">
						...
						<input type="number"min="0" class="form-control" id="CodigoPostal" name="CodigoPostal" placeholder="Introduce tu CP">
					</div>
		  		...
		  		<div class="form-group col-xl-2">
						...
						<input type="text"min="0" class="form-control" id="Estado" name="Estado" placeholder="Estado de México" value="Estado de México" readonly>
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="form-group col-xl-3">
							...
							<input type="text" class="form-control" id="Curp" name="Curp"	placeholder="Introduce tu CURP">
						</div>

						<div class="form-group col-xl-4">
							<label for="ejemplo_email_1">Secundaria de Procedencia</label>
							<input type="text" class="form-control" id="SecProcedencia" name="SecProcedencia"	placeholder="Introduce tu Sec. de Procedencia">
						</div>
						...
						<div class="form-group col-xl-4">
							...
							<input type="text" class="form-control" id="FolioAsignado" name="FolioAsignado" placeholder="Introduce tu Folio Asignado">
						</div>
  				...
  				<div class="row">
						...
						<div class="col-xl-12">
							...
							<div class="form-group col-xl-4">
								...
								@endif
								<label for="ejemplo_email_1">Nombre</label>
								<input type="text" class="form-control" id="NombrePadre" name="NombrePadre" placeholder="Introduce su Nombre">
							</div>
							...
							<div class="form-group col-xl-4">
								...
								@endif
								<label for="ejemplo_email_1">Apellido Paterno</label>
								<input type="text" class="form-control" id="APPadre" name="APPadre" placeholder="Introduce su Apellido Paterno">
							</div>
						...
						<div class="form-group col-xl-3">			
							...
							@endif
							<label for="ejemplo_email_1">Apellido Materno</label>
							<input type="text" class="form-control" id="AMPadre" name="AMPadre" placeholder="Introduce su Apellido Materno">
						</div>
						...
						<div class="form-group col-xl-3">
							...
							@endif
							<label for="ejemplo_email_1">Celular</label>
							<input type="text" class="form-control" id="CelularPadre" name="CelularPadre" placeholder="Introduce su Número Celular">
						</div>
						<br><br>
						...
						<div class="col-xl-12">
							...
							<div class="form-group col-xl-4">
								...
								@endif
								<label for="ejemplo_email_1">Nombre</label>
								<input type="text" class="form-control"id="NombreMadre" name="NombreMadre" placeholder="Introduce su Nombre">
							</div>
							...
							<div class="form-group col-xl-4">
								...
								@endif
								<label for="ejemplo_email_1">Apellido Paterno</label>
								<input type="text" class="form-control"id="APMadre" name="APMadre" placeholder="Introduce su Apellido Paterno">
							</div>
							...
							<div class="form-group col-xl-3">
								...
								@endif
								<label for="ejemplo_email_1">Apellido Materno</label>
								<input type="text" class="form-control" id="AMMadre" name="AMMadre" placeholder="Introduce su Apellido Materno">
							</div>
							...
							<div class="form-group col-xl-3">
								...
								@endif
								<label for="ejemplo_email_1">Celular</label>
								<input type="text" class="form-control" id="CelularMadre" name="CelularMadre" placeholder="Introduce Número Celular">
							</div>
						</div>
